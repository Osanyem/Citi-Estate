...
<head>
     ...
     <title>Citi Estate | MANAGE PROPERTIES</title>
...
$details = $r->getPropDetails();
 ...
 <!-- Page Content -->
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Property Page</h1>
  ...
  <div class="col-lg-9 mb-4">
      <?php
        ...
        echo "<tr> 
              ...
              <th style='padding:2px'>House Size (in sqft)</th>
              <th style='padding:2px'>Lot Size (in sqft)</th>
              <th style='padding:2px'>Number of Bedrooms</th>
              <th style='padding:2px'>Number of Bathrooms</th>
              <th style='padding:2px'>Property Description</th>
              <th style='padding:2px'>Property Option</th>
              <th style='padding:2px'>Property Type</th>
              <th style='padding:2px'>Property Price</th>
              <th style='padding:2px'>Actions</th>
              </tr>";
if (!empty($details)) {
        foreach ($details as $item) {
          echo "<tr> <td>" . $item['property_location'] . "</td><td>" . $item['property_size'] . "</td><td>" . $item['property_lotsize'] . "</td><td>" . $item['property_bedrooms'] . "</td><td>" . $item['property_bathrooms'] . "</td><td>" . $item['property_description'] . "</td><td>" . $item['property_option'] . "</td><td>" . $item['property_type'] . "</td><td>" . number_format($item['property_price'],2) . "</td><td><a href='forms/delete_prop.php?id=". $item['property_id'] ."'>Delete</a></td></tr>";
        }}
