    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9 mb-4">
          <h2>Hi <?php echo $details['fname'] . ' ' . $details['lname']; ?>,</h2>
          <p>This is your Citi Estate profile page, from here you can upload properties and manage properties which you
            have you uploaded to Citi Estate.</p>
        </div>
      </div>
      <!-- /.row -->
      ...
      <div class="row">
        <div class="col-sm-12 col-md-8 offset-md-2">
          <p style="text-align:center; font-size:0.7em">Citi Estate is committed to ensuring digital accessibility for
            individuals with disabilities. We are continuously working to improve the accessibility of our web experience
            for everyone, and we welcome feedback and accommodation requests. If you wish to report an issue or seek an
