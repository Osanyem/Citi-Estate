...
<head>
     ...
     <style type="text/css">
        ...
        #searchBar   {min-height: 500px;  background-image:url('../media/rent_page/bi.png'); background-size: cover;               background-attachment:fixed;}
...
$details = $r->getPropDetailsOpt('rent');
$pics = $r->getPropImg('rent');
?>
